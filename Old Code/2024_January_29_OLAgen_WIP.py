...
class genbankWindow(QDialog):
    ...
    def __init__(self):
        ...
        #uic.loadUi("/Users/daltonjaynelson/Documents/Research/OLAgen/GUI/2024 Jan - OLAgen GUI GenBank v3.ui", self)
        self.show()
...
class olaGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi("/Users/daltonjaynelson/Documents/Research/OLAgen/GUI/2024 Jan - OLAgen GUI Main v3.ui", self)
        self.show()
