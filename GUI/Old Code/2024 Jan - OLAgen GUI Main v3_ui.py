...
################################################################################
## Form generated from reading UI file '2024 Jan - OLAgen GUI Main v3.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.olagenLogo.setGeometry(QRect(190, 90, 461, 201))
        ...
        self.fastaInputButton.setGeometry(QRect(380, 280, 141, 26))
        self.helpButton = QPushButton(self.centralwidget)
        self.helpButton.setObjectName(u"helpButton")
        self.helpButton.setGeometry(QRect(520, 280, 81, 26))
        self.genbankInputButton = QPushButton(self.centralwidget)
        self.genbankInputButton.setObjectName(u"genbankInputButton")
        self.genbankInputButton.setGeometry(QRect(190, 280, 191, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fastaInputButton.setText(QCoreApplication.translate("MainWindow", u"Select .fasta File", None))
        self.helpButton.setText(QCoreApplication.translate("MainWindow", u"Help", None))
        self.genbankInputButton.setText(QCoreApplication.translate("MainWindow", u"Input GenBank Accession", None))
